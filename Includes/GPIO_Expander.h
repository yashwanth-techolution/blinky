#ifndef GPIO_EXPANDER_MODULE_H
#define GPIO_EXPANDER_MODULE_H

#include <stdint.h>
#include <stdbool.h>
#include <inttypes.h>

#define MCP230_I2C_ADDR 0x20
...
/* Used with GPIO Expander */
#define LED_CONTROL       9    // for LED strip on/off
#define CHIRP_INT         8    // for ultrasonic sensor

// for sensor 1
#define BOARD_2           1
#define CHIRP_RST_1       4    // for ultrasonic sensor
#define CHIRP_PROG_1      3    // for ultrasonic sensor

// for sensor 0
#define BOARD_1           0
#define CHIRP_RST_0       5    // for ultrasonic sensor
#define CHIRP_PROG_0      6    // for ultrasonic sensor

// for sensor 2
#define CHIRP_RST_2       2    // for ultrasonic sensor
#define CHIRP_PROG_2      1    // for ultrasonic sensor

// for sensor 3
#define CHIRP_RST_3       0    // for ultrasonic sensor
#define CHIRP_PROG_3      7    // for ultrasonic sensor
