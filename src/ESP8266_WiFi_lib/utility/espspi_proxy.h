...
#include <zephyr.h> // added by samuel
...
//void espSpiProxy_begin(uint8_t pin);
...
//    void begin(uint8_t pin) // added by samuel
//    {
//        //spi_obj = in_spi;  // cmd by samuel
...
//        //spi_obj->transfer(CMD_READSTATUS);  // cmd by samuel
//        //uint16_t status = (spi_obj->transfer(0) | ((uint16_t)(spi_obj->transfer(0)) << 8));  // cmd by samuel
        
//        _pulseSS(false);

//        //return status;
//        return 0;  // added by samuel
//    }
