...
#include "src/syntiant_ilib/syntiant-firmware/ndp10x_mb.h"
#include "src/syntiant_ilib/syntiant-firmware/ndp10x_result.h"
#include "src/syntiant_ilib/syntiant-firmware/ndp10x_mcu.h"
...
enum ndp10x_firmware_constants_e {
    ...
    NDP10X_MATCH_NOISE_THRESHOLD_MASK =
        0xff << NDP10X_MATCH_NOISE_THRESHOLD_SHIFT
};
