...
#include "src/syntiant_ilib/syntiant_ilib/syntiant_ndp10x_driver.h"
#include "src/syntiant_ilib/syntiant_ilib/syntiant_ndp120_driver.h"
#include "src/syntiant_ilib/syntiant_packager/syntiant_package.h"
...
struct syntiant_ndp_device_s {
    ...
    union {
        ...
        syntiant_ndp120_device_t ndp120;
    } d;
};
